  ...
  return (
    ...
    >
      <header className="mb-4">
        <h2 id="place-inflow" className="text-base font-semibold text-zinc-100 sm:text-lg">
          플레이스 유입수
        </h2>
        <p className="mt-1 text-sm text-zinc-500">기간 내 일/월/연 단위 플레이스 유입수 추이입니다.</p>
      </header>
                    ...
                    return (
                      <div className="rounded border border-zinc-700 bg-zinc-950 px-2.5 py-1.5 text-xs shadow-lg">
                        ...
                        <p className="text-zinc-100">
                          값 <span className="text-zinc-300">{formatNumber(Number.isFinite(n) ? n : null)}명</span>
                        </p>
                      </div>
                    );
                  }}
